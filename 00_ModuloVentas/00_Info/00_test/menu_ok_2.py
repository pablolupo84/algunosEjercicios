...
class ModuloVentas:
    def __init__(self):
        ...
        self.miFrame = Frame(self.windowsVender)
        self.miFrame.pack()

        #print (articulosTotal.consultar())
        self.tituloLabel=Label(self.miFrame,text="Venta de Productos ",fg="blue",bg="white",font=("Times New Roman",20))
        self.tituloLabel.grid(row=0, column=1, padx=10, pady=10,sticky="we")

        self.botonVender = Button(self.miFrame, text="VENDER")
        self.botonVender.grid(row=1, column=2, padx=10, pady=10)

        self.botonCancelar = Button(self.miFrame, text="CANCELAR VENTA")
        self.botonCancelar.grid(row=2, column=2, padx=10, pady=10)


        self.tree = ttk.Treeview(self.miFrame,columns = ("id_articulo","descripcion","codigo","stock","precio_vta"))   
        ...
        self.tree.column('#1',width=150,minwidth=100,stretch=tk.YES)
        ...
        self.tree.column('#5',width=150,minwidth=100,stretch=tk.YES)
    ...
    def OnDoubleClick(self, event):
        ...
        print("you clicked on itemID: ", self.tree.item(item,"values")[0])
